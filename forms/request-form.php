...
require __DIR__ . '/../wp-includes/PHPMailer/src/Exception.php';
require __DIR__ . '/../wp-includes/PHPMailer/src/PHPMailer.php';
require __DIR__ . '/../wp-includes/PHPMailer/src/SMTP.php';
